# Understanding CONTOURS in OPEN CV
import numpy as np
import cv2
...
cv2.createTrackbar('Hue Low','myTracker',150,180,onTrack1)
cv2.createTrackbar('Hue High','myTracker',180,180,onTrack2)

cv2.createTrackbar('Hue Low2','myTracker',0,180,onTrack7)
cv2.createTrackbar('Hue High2','myTracker',8,180,onTrack8)

cv2.createTrackbar('Sat Low','myTracker',153,255,onTrack3)
cv2.createTrackbar('Sat High','myTracker',255,255,onTrack4)
cv2.createTrackbar('Val Low','myTracker',93,255,onTrack5)
